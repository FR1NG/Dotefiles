...
# Type: QtColor
c.colors.tabs.selected.odd.bg = '#5C469C'

# Background color of selected even tabs.
# Type: QtColor
c.colors.tabs.selected.even.bg = '#5C469C'

# Background color of pinned unselected odd tabs.
# Type: QtColor
c.colors.tabs.pinned.odd.bg = '#0E2954'

# Background color of pinned unselected even tabs.
# Type: QtColor
c.colors.tabs.pinned.even.bg = '#0E2954'

# Background color of pinned selected odd tabs.
# Type: QtColor
c.colors.tabs.pinned.selected.odd.bg = '#5C469C'

# Background color of pinned selected even tabs.
# Type: QtColor
c.colors.tabs.pinned.selected.even.bg = '#5C469C'
...
config.bind('sa', 'set tabs.show always')
config.bind('sn', 'set tabs.show never')
